...
TF1 = [1 0 0 0.642; 0 1 0 0.088; 0 0 1 0.175; 0 0 0 1];
TF2 = [1 0 0 0.344; 0 1 0 0.473; 0 0 1 0.175; 0 0 0 1];
TF3 = [1 0 0 0.344; 0 1 0 0.473; 0 0 1 0.030; 0 0 0 1];
TF4 = [1 0 0 0.344; 0 1 0 0.473; 0 0 1 0.175; 0 0 0 1];
TF5 = [1 0 0 0.344; 0 1 0 -0.473; 0 0 1 0.175; 0 0 0 1];
TF6 = [1 0 0 0.344; 0 1 0 -0.473; 0 0 1 0.030; 0 0 0 1];

q0=[(4*pi/180); (3.2*pi/180);(0.0175);0];
q1 = Robo2.ikine(TF1,'qo',q0,'mask',[1, 1, 1, 1, 0 ,0],'ilimit',100,'rlimit',1000,'verbose');
q2 = Robo2.ikine(TF2,'qo',q1,'mask',[1, 1, 1, 1, 0 ,0],'ilimit',100,'rlimit',1000,'verbose');
q3 = Robo2.ikine(TF3,'qo',q2,'mask',[1, 1, 1, 1, 0 ,0],'ilimit',100,'rlimit',1000,'verbose');
q4 = Robo2.ikine(TF4,'qo',q3,'mask',[1, 1, 1, 1, 0 ,0],'ilimit',100,'rlimit',1000,'verbose');
q5 = Robo2.ikine(TF5,'qo',q4,'mask',[1, 1, 1, 1, 0 ,0],'ilimit',100,'rlimit',1000,'verbose');
q6 = Robo2.ikine(TF6,'qo',q5,'mask',[1, 1, 1, 1, 0 ,0],'ilimit',100,'rlimit',1000,'verbose');
Movement1= jtraj(q0, q1, (0:.08:1));
Movement2= jtraj(q1, q2, (0:.08:1));
Movement3= jtraj(q2, q3, (0:.08:1));
Movement4= jtraj(q3, q4, (0:.08:1));
Movement5= jtraj(q4, q5, (0:.08:1));
Movement6= jtraj(q5, q6, (0:.08:1));

Robo2.plot(Movement1,'workspace',W);
Robo2.plot(Movement2,'workspace',W);
Robo2.plot(Movement3,'workspace',W);
Robo2.plot(Movement4,'workspace',W);
Robo2.plot(Movement5,'workspace',W);
Robo2.plot(Movement6,'workspace',W);
%% INCERTEZAS:
